...
export class CloudinaryVideo {
  ...
  play() {
    ...
    document.getElementById('divpreviewVideo').style.display = 'none';
    document.getElementById('divplayVideo').style.display = 'block';
  }
  ...
  showPreview() {
    ...
    console.log('showPreview', this.videoEl);
  }
  ...
  hidePreview() {
    ...
    console.log('hidePreview', this.videoEl);
  }

  render() {
    return (
      <div onMouseEnter={this.showPreview.bind(this)} onMouseLeave={this.hidePreview.bind(this)} class="mv-video-item" style={{'width':`${this.width}px`,'height':`${this.height}px`}}>
        <div id="divpreviewVideo" class="mv-video-item-active">
          <video id="previewVideo" poster={this.poster} autoplay loop width={this.width} height={this.height}></video>
        </div>
        <div id="divplayVideo" class="mv-video-item-video">
